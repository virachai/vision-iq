...
// Return ONLY a valid JSON object. Do not include any markdown formatting (like \`\`\`json), commentary, or extra text. Your entire response must be parseable as standard JSON.`;
//   }
...
// Return ONLY a valid JSON ARRAY of objects. Do not include any markdown formatting (like \`\`\`json), commentary, or extra text. Your entire response must be parseable as standard JSON. Each object MUST include the "id" field.`;
//   }
